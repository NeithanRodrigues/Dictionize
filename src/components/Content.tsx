function Content() {
  return (
    <div className="md:w-[50%] w-[90%] m-auto text-justify">
      ...
      <h1 className="text-2xl md:text-3xl mt-14 text-[#A0E79E] font-bold"> How to use</h1>

      <p className="mt-5 text-[14px] md:text-[16px]">To use Dictionize, just type any word into the search bar and click "Submit." The site will instantly fetch and display the word's definition, related terms, and even examples of usage. It’s a fun, efficient way to learn and discover new words!</p>

      <h1 className="text-2xl md:text-3xl mt-14 text-[#A0E79E] font-bold"> About</h1>
      <p className="mt-5 text-[14px] md:text-[16px]">This is your ideal platform to explore word meanings, synonyms, antonyms and more! Whether you're a student, writer, or just curious about the language, this site makes it easy to quickly find and understand word definitions. Designed with a simple and intuitive interface, Dictionize is here to improve your vocabulary in just a few clicks.</p>
      <br></br>
